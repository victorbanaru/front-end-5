...
Game.prototype.updateGameDetails = function() {
  var that = this;
  return $.post("https://games-world.herokuapp.com/games/" + this.id)
    .then(function(response) {
      that.title = response.title;
//       that.imageUrl = response.imageUrl;
      that.description = response.description;  
...
Game.prototype.deleteGame = function() {
  var that = this;
  return $.delete("https://games-world.herokuapp.com/games/" + this.id)
//     .then(function(response) {
//       that.title = response.title;
//       that.imageUrl = response.imageUrl;
//       that.description = response.description;  
